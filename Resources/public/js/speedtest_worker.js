...
var settings = {
  ...
  url_dl: '../php/garbage.php', // path to a large file or garbage.php, used for download test. must be relative to this js file
  url_ul: '../php/empty.php', // path to an empty file, used for upload test. must be relative to this js file
  url_ping: '../php/empty.php', // path to an empty file, used for ping test. must be relative to this js file
  url_getIp: '../php/getIP.php', // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
